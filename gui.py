...
class CustomSpecifications(MainMenuButton):
    def press(self):
        ...
        create_button(self.ui.container, "Back to Homepage", row_count, 0, self.ui.create_menu_buttons, pady=(5, 0), ipady=10, fg="black", bg="pink")
        ...
        for input in self.inputs:
            ...
            for index, entry in enumerate(input.entries):
                if isinstance(entry, bool) or isinstance(entry, str):
                    outputs.append(types[index](entry))
                elif entry.winfo_class() == 'Entry':
                    outputs.append(types[index](entry.get()))
            o.append(outputs)
        task_a.custom_specifications(o[0][0], o[1][0], o[2][0], o[3][0], o[4], o[5], o[6], o[7], o[8], o[9])
